...
@section('content')
    @php
        ...
        $storeRoute = $isSuperAdmin ? 'admin.websites.bizhub.store' : 'admin.panel.websites.bizhub.store';
    @endphp
    ...
    <div class="mb-6">
        ...
        <div>
            <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2 bg-gradient-to-r from-[#132A13] via-[#2F4F2F] to-[#132A13] bg-clip-text text-transparent">
                Tambah BizHub Baharu
            </h1>
            <p class="text-sm sm:text-base text-gray-600">Isi maklumat perniagaan untuk ditambah ke dalam sistem</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-lg border border-gray-200 overflow-hidden">
        ...
        <div class="p-6 sm:p-8">
            <form class="grid grid-cols-1 md:grid-cols-2 gap-6" method="POST"
                action="{{ route($storeRoute) }}" enctype="multipart/form-data">
                @csrf
                @method('POST')
                ...
                <div class="md:col-span-2">
                    <label for="gambar" class="block text-sm font-semibold text-gray-700 mb-2">
                        Gambar Perniagaan <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
