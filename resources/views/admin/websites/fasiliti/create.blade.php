...
@section('content')
    @php
        ...
        $storeRoute = $isSuperAdmin ? 'admin.websites.fasiliti.store' : 'admin.panel.websites.fasiliti.store';
    @endphp
    ...
    <div class="mb-6">
        ...
        <div>
            ...
            <p class="text-sm sm:text-base text-gray-600">Isi maklumat fasiliti untuk ditambah ke dalam sistem</p>
        </div>
    </div>
            ...
            <form action="{{ route($storeRoute) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    <label for="gambar" class="block text-sm font-semibold text-gray-700 mb-2">
                        Gambar Fasiliti <span class="text-red-500">*</span>
                    </label>
                    <div class="relative">
