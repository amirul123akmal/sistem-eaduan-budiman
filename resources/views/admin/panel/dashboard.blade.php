						...
						@foreach($recentComplaints as $complaint)
							<tr class="hover:bg-gray-50">
								...
								<td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
									<a href="{{ route('admin.panel.complaints.show', $complaint) }}" class="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-1.5 text-xs text-gray-700 shadow-sm hover:bg-gray-50">
