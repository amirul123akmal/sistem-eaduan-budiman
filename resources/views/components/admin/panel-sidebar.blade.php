...
<aside id="admin-sidebar" class="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-gradient-to-b from-white to-gray-50/50 shadow-2xl transition-transform lg:translate-x-0" aria-label="Sidebar" tabindex="-1">
	<div class="flex h-full flex-col justify-between overflow-y-auto px-4 py-6">
		<div>
			<div class="mb-8 px-3">
				<a href="{{ route('admin.panel.dashboard') }}" class="group flex items-center justify-center transition-transform duration-300 hover:scale-105">
					<div class="relative">
			...
			<nav class="space-y-2">
				{{-- Dashboard --}}
				<a href="{{ route('admin.panel.dashboard') }}" class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if(request()->routeIs('admin.panel.dashboard')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
					...
					@endif
					<span class="relative inline-flex h-5 w-5 items-center justify-center @if(request()->routeIs('admin.panel.dashboard')) text-white @else text-gray-500 group-hover:text-[#132A13] @endif">
				...
				<a href="{{ route('admin.panel.complaints.index') }}" class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if(request()->routeIs('admin.panel.complaints.*')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
					@if(request()->routeIs('admin.panel.complaints.*'))
						<div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
					@endif
					<span class="relative inline-flex h-5 w-5 items-center justify-center @if(request()->routeIs('admin.panel.complaints.*')) text-white @else text-gray-500 group-hover:text-[#132A13] @endif">
				...
				<a href="{{ route('admin.panel.complaint-types.index') }}" class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if(request()->routeIs('admin.panel.complaint-types.*')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
					@if(request()->routeIs('admin.panel.complaint-types.*'))
						<div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
					@endif
					<span class="relative inline-flex h-5 w-5 items-center justify-center @if(request()->routeIs('admin.panel.complaint-types.*')) text-white @else text-gray-500 group-hover:text-[#132A13] @endif">
				...
				<a href="{{ route('admin.panel.audit-trails.index') }}" class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if(request()->routeIs('admin.panel.audit-trails.*')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
					@if(request()->routeIs('admin.panel.audit-trails.*'))
						<div class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"></div>
					@endif
					<span class="relative inline-flex h-5 w-5 items-center justify-center @if(request()->routeIs('admin.panel.audit-trails.*')) text-white @else text-gray-500 group-hover:text-[#132A13] @endif">
