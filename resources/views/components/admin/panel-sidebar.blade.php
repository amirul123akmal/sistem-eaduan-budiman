        ...
        <div>
            ...
            <nav class="space-y-2">
                ...
                <a href="{{ route('admin.panel.websites.bizhub.index') }}"
                    class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if (request()->routeIs('admin.panel.websites.bizhub.*')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
                    @if (request()->routeIs('admin.panel.websites.bizhub.*'))
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        </div>
                    @endif
                ...
                <a href="{{ route('admin.panel.websites.pengumuman.index') }}"
                    class="group relative flex items-center gap-3 rounded-xl py-2.5 px-4 text-sm font-medium transition-all duration-200 @if (request()->routeIs('admin.panel.websites.pengumuman.*')) bg-gradient-to-r from-[#132A13] to-[#2F4F2F] text-white shadow-lg shadow-[#132A13]/30 @else text-gray-700 hover:bg-[#F0F7F0] hover:text-[#132A13] @endif">
                    @if (request()->routeIs('admin.panel.websites.pengumuman.*'))
                        <div
                            class="absolute inset-0 bg-gradient-to-r from-white/0 to-white/10 rounded-xl opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                        </div>
                    @endif
                    <span
                        class="relative inline-flex h-5 w-5 items-center justify-center @if (request()->routeIs('admin.panel.websites.pengumuman.*')) text-white @else text-gray-500 group-hover:text-[#132A13] @endif">
                        <svg class="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
